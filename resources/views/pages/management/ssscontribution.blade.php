...
<style>
    ...
    #mdlSSS .modal-content { border-radius:var(--radius-card); border:none; overflow:hidden; }
    #mdlSSS .modal-header { background:var(--teal); color:#fff; border-bottom:none; padding:16px 22px; }
    #mdlSSS .modal-header .modal-title, #mdlSSS .modal-header .modal-title label { color:#fff; }
    #mdlSSS .btn-close { filter:brightness(0) invert(1); }
    #mdlSSS .modal-body { background:var(--bg); padding:22px; }
    #mdlSSS .modal-footer { background:var(--surface); border-top:1px solid var(--border); }
...
<div class="ctb-shell">
    <div class="ctb-topbar">
        <div>
            <p class="page-title">SSS Contribution Table</p>
            <p class="page-sub">Social Security System salary brackets and contribution shares used by payroll</p>
        </div>
        <div class="ctb-tools">
            <div>
            ...
            <button class="btn-add" id="btnCreateSSS" data-bs-toggle="modal" data-bs-target="#mdlSSS">
    ...
    <div class="sc">
        <div class="sc-head">
            <div class="sc-head-left">
                <div class="sc-icon"><i class="fa-solid fa-hand-holding-medical"></i></div>
                <h5 class="sc-title">SSS Contribution Brackets</h5>
            </div>
        ...
        <div class="table-responsive" style="max-height:75vh; overflow-y:auto;">
            <table class="table table-hover align-middle ctb-table mb-0">
                ...
                <tbody id="tblSSS"></tbody>
            </table>
        </div>
    </div>
</div>

<div class="modal fade" id="mdlSSS" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa-solid fa-hand-holding-medical me-2"></i><label class="lblActionDesc" id="lblTitleSSS">Add SSS Bracket</label></h5>
            ...
            <div class="modal-body">
                <form id="frmSSS">
                    ...
                    <div class="sub-divider"><span>Contribution Shares</span></div>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="field-label">Employee Share (EE) <span class="req">*</span></label>
                            <input class="form-control" id="txtEE" name="employee_share" type="number" step="0.01" placeholder="-"/>
                            <span class="text-danger small error-text employee_share_error"></span>
                        </div>
                        <div class="col-md-6">
                            <label class="field-label">Employer Share (ER) <span class="req">*</span></label>
                            <input class="form-control" id="txtER" name="employer_share" type="number" step="0.01" placeholder="-"/>
                            <span class="text-danger small error-text employer_share_error"></span>
                        </div>
                        <div class="col-md-4">
                            <label class="field-label">EC (Employer)</label>
                            <input class="form-control" id="txtEC" name="ec" type="number" step="0.01" placeholder="0"/>
                            <span class="text-danger small error-text ec_error"></span>
                        </div>
                        <div class="col-md-4">
                            <label class="field-label">MPF</label>
                            <input class="form-control" id="txtMPF" name="mpf" type="number" step="0.01" placeholder="0"/>
                            <span class="text-danger small error-text mpf_error"></span>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="hint"><i class="fa-solid fa-circle-info me-1"></i> Payroll uses the bracket with the <b>highest effective year</b> that matches an employee's monthly salary. To roll out a new schedule, add the new year's brackets — older years stay as history.</div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancel</button>
                <button id="btnSaveSSS" type="button" class="btn-submit">Save</button>
            </div>
        </div>
    </div>
</div>
