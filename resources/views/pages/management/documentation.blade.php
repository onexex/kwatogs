                ...
                <div class="sc-body">
                    <table class="doc-table">
                        ...
                        <tbody>
                            ...
                            <tr><td class="item-name"><i class="fa-solid fa-database"></i>Database Backup</td><td class="url">/pages/management/databasebackup</td><td><code class="kk">databasebackup</code></td><td>Create, download, restore and delete database backups.</td></tr>
                            ...
                            <tr><td class="item-name"><i class="fa-solid fa-calendar-check"></i>Leave Valid.</td><td class="url">/pages/management/leavevalidations</td><td><code class="kk">leavevalidations</code></td><td>Configure validation rules for leave filing.</td></tr>
                            <tr><td class="item-name"><i class="fa-solid fa-clock-rotate-left"></i>Lilo Valid.</td><td class="url">/pages/management/lilovalidations</td><td><code class="kk">lilovalidations</code></td><td>Configure log-in/log-out (LILO) validation rules.</td></tr>
