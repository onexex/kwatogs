        ...
        <div>
                ...
                <div class="sc-body">
                    <table class="doc-table">
                        ...
                        <tbody>
                            ...
                            <tr><td class="item-name"><i class="fa-solid fa-stopwatch"></i>Apply Employee Overtime</td><td class="url">/pages/modules/admin-overtime</td><td><code class="kk">adminovertime</code></td><td>File overtime on behalf of an employee. Administrators (and overtime approvers) file for the whole company and the record is saved <b>Approved</b>; a <b>Supervisor</b> files only for their own department and the record is saved <b>For Approval</b>, routed to Pending Overtime Requests.</td></tr>
                            ...
                            <tr><td class="item-name"><i class="fa-solid fa-pen-to-square"></i>Summary Logs Management</td><td class="url">/pages/modules/summary-logs</td><td><code class="kk">summarylogs</code></td><td>Back-door editor over the computed daily attendance summaries: overwrite Duration (Gross), Deductions, Late, Undertime, Night Diff, Passout and Over Break per employee/day (Net Duration is always derived as Gross &minus; Deductions). Only days with a computed summary are listed. Days already covered by a <b>generated payroll run are locked</b> (lock badge instead of Edit) — delete/regenerate that payroll first, then edit. Every edit is written to the Audit Trail with a before&rarr;after diff.</td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
                ...
                <div class="sc-body">
                    <table class="doc-table">
                        ...
                        <tbody>
                            ...
                            <tr><td class="item-name"><i class="fa-solid fa-receipt"></i>BIR Withholding (1601-C / Alphalist)</td><td class="url">/reports/bir</td><td><code class="kk">birreport</code></td><td>Withholding tax on compensation &mdash; monthly 1601-C or annual 1604-C alphalist (Form 2316 basis). Excel + print.</td></tr>
                            <tr><td class="item-name"><i class="fa-solid fa-building-columns"></i>SSS Contribution (R-3)</td><td class="url">/reports/sss</td><td><code class="kk">sssreport</code></td><td>Monthly SSS Contribution Collection List &mdash; EE/ER shares per member. Excel + print.</td></tr>
                            <tr><td class="item-name"><i class="fa-solid fa-heart-pulse"></i>PhilHealth (RF-1)</td><td class="url">/reports/philhealth</td><td><code class="kk">philhealthreport</code></td><td>Monthly PhilHealth premium remittance (RF-1) &mdash; EE/ER shares per member. Excel + print.</td></tr>
                            <tr><td class="item-name"><i class="fa-solid fa-house-chimney"></i>Pag-IBIG (MCRF)</td><td class="url">/reports/pagibig</td><td><code class="kk">pagibigreport</code></td><td>Monthly Pag-IBIG contributions + STL loan amortizations (MCRF). Excel + print.</td></tr>
                            <tr><td class="item-name"><i class="fa-solid fa-table-list"></i>Payroll Register</td><td class="url">/reports/payroll-register</td><td><code class="kk">payrollregister</code></td><td>Full earnings &rarr; deductions &rarr; net per employee for a pay run. Excel + print.</td></tr>
                            <tr><td class="item-name"><i class="fa-solid fa-book"></i>Payroll Journal (GL)</td><td class="url">/reports/payroll-journal</td><td><code class="kk">payrolljournal</code></td><td>Per-department cost breakdown + balanced journal entry for GL posting. Excel + print.</td></tr>
                            <tr><td class="item-name"><i class="fa-solid fa-hand-holding-dollar"></i>Loan Ledger</td><td class="url">/reports/loan-ledger</td><td><code class="kk">loanledger</code></td><td>All loans/advances with principal, total paid, and outstanding balance. Excel + print.</td></tr>
                            <tr><td class="item-name"><i class="fa-solid fa-clock"></i>Daily Time Record (DTR)</td><td class="url">/reports/dtr</td><td><code class="kk">dtrreport</code></td><td>Per-employee monthly time record: daily in/out, hours, late, undertime, status. Excel + print.</td></tr>
                            <tr><td class="item-name"><i class="fa-solid fa-user-xmark"></i>Tardiness &amp; Absences</td><td class="url">/reports/tardiness</td><td><code class="kk">tardinessreport</code></td><td>Per-employee late/undertime/absence tally for a month, ranked worst-first. Excel + print.</td></tr>
                            <tr><td class="item-name"><i class="fa-solid fa-users"></i>Headcount &amp; Turnover</td><td class="url">/reports/headcount</td><td><code class="kk">headcountreport</code></td><td>Active headcount by dept/classification + new hires, separations, and turnover rate. Excel + print.</td></tr>
                            <tr><td class="item-name"><i class="fa-solid fa-calendar-check"></i>Leave Ledger</td><td class="url">/reports/leave-ledger</td><td><code class="kk">leaveledger</code></td><td>Per-employee leave credits allocated/used/balance cross-referenced with leave filed. Excel + print.</td></tr>
                            <tr><td class="item-name"><i class="fa-solid fa-triangle-exclamation"></i>Disciplinary Notices</td><td class="url">/reports/notices</td><td><code class="kk">noticesreport</code></td><td>Per-employee memo &amp; disciplinary tally with escalation flags + pending suspension recommendations. Excel + print.</td></tr>
                            <tr><td class="item-name"><i class="fa-solid fa-file-contract"></i>COE Issuance Log</td><td class="url">/reports/coe-log</td><td><code class="kk">coereport</code></td><td>Every COE request with status, certificate no., purpose, signatory &amp; review trail. Excel + print.</td></tr>
                            <tr><td class="item-name"><i class="fa-solid fa-money-check-dollar"></i>Final Pay Computation</td><td class="url">/reports/final-pay</td><td><code class="kk">finalpayreport</code></td><td>Separated-employee final pay estimate: pro-rated 13th month + unused-leave conversion. Excel + print.</td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
            ...
            <section class="sc" id="access">
                ...
                <div class="sc-body prose">
                    ...
                    <p>The built-in <b>Supervisor</b> role is a limited example of this: it holds only <code class="kk">adminovertime</code>, so a supervisor can file overtime for the employees in their own department but cannot approve it. Anything they file is saved <b>For Approval</b> and sent to an approver — a supervisor cannot approve their own filings. Administrators, by contrast, file for the whole company and their filings are saved approved. Assign the role from <b>Settings → Employee Role</b> like any other.</p>
                </div>
                <div class="note">
