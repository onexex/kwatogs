@extends('layout.app', ['title' => 'Overtime Import'])
@section('content')
...
<div class="ai-shell">
    ...
    <div class="sc">
        ...
        <div class="sc-body">
            <div class="ai-note">
                <b>How it works:</b> one row = one overtime entry. The system computes <b>hours</b> and <b>pay</b> from each
                employee's basic salary and the <b>Day Type</b> (first 8h &times; the day-type rate, beyond 8h &times; 1.25, minus a 1-hour
                meal break when the span is &ge; 8h). Leave Total Hrs / Total Pay blank to auto-compute, or fill to override.
                Status defaults to <b>APPROVEDBYCFO</b> so it counts in payroll immediately.<br>
                <b>Day Type values:</b>
                <code>regular</code> <code>rest_day</code> <code>special_holiday</code> <code>regular_holiday</code>
                <code>rest_day_regular_holiday</code> <code>rest_day_special_holiday</code>
                <code>rest_day_double_regular_holiday</code> <code>double_holiday</code>.
                Employees matched by Employee ID. Re-importing the same employee + date + time-in updates instead of duplicating.
            </div>
...
$(function () {
    ...
    $('#aiForm').on('submit', function (e) {
        ...
        axios.post("{{ route('overtime-import.upload') }}", fd)
            .then(res => {
                Swal.close();
                const d = res.data;
