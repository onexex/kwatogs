...
<div class="container-fluid">
    <div class="mb-2"><h4 class="mb-0 text-gray-800">Overtime Report</h4></div>
...
$(function () {
    ...
    function load(page = 1) {
        ...
        axios.get('/reports/overtime/fetch', { params: { ...params(), page } }).then(res => {
            ...
            $('#tbl').html(h);
            $('#tfoot').html(`<tr class="fw-bold"><td colspan="4" class="text-end">Page Totals:</td><td class="text-end">${th.toFixed(2)}</td><td class="text-end">${peso(tp)}</td><td colspan="2"></td></tr>`);
