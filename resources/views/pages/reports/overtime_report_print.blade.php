...
<body>
    ...
    <table>
        ...
        <tfoot>
            <tr>
                <td colspan="5" style="text-align:right;text-transform:uppercase;letter-spacing:.4px;">Total</td>
    ...
    <div class="note">
        Overtime hours and pay are computed based on approved overtime requests. Pay amounts reflect the applicable overtime rate.
        Status reflects the current approval stage of each overtime application.
    </div>
