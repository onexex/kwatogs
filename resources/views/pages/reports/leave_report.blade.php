...
<div class="rpt-shell">
    <div class="rpt-topbar">
        <p class="page-title">Leave Report</p>
        <p class="page-sub">Filter and review employee leave records</p>
    </div>
...
$(function () {
    ...
    function load(page = 1) {
        ...
        axios.get('/reports/leave/fetch', { params: { ...params(), page } }).then(res => {
            ...
            $('#tbl').html(h);
            $('#tfoot').html(`<tr><td colspan="5" class="text-end">Page Total Days:</td><td class="text-end">${td.toFixed(2)}</td><td colspan="3"></td></tr>`);
