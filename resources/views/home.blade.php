            ...
            <div class="col-12 text-end">
                <div class="d-inline-flex gap-3 ">
                    <button type="button" id="btnTimeOut"
                        class="btn btn-danger rounded-pill px-4 py-2 fw-bold shadow-sm transition-hover">
                        <i class="bi bi-box-arrow-right me-1"></i> Time Out
                    </button>
                    <button type="button" id="btnTimeIn"
                        class="btn btn-primary rounded-pill px-4 py-2 fw-bold shadow-sm transition-hover">
        ...
        $(document).ready(function() {
            ...
            $('#btnTimeIn').click(e => {
                ...
                handleAttendancePunch('in', "{{ route('attendance.timein') }}", 'Confirm Time In?',
                    'Ready to log your attendance?', '#0d6efd');
            });

            $('#btnTimeOut').click(e => {
                e.preventDefault();
                handleAttendancePunch('out', "{{ route('attendance.timeout') }}", 'Confirm Time Out?',
                    'End your shift for the day?', '#dc3545');
            });
