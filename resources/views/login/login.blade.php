...
<head>
    ...
    <style>
        ...
        .img-logo {
            ...
            background-image: url('../img/kwatogslogo.jpg?v=demo');
            ...
            <div class="col-lg-6 col-md-12">
                <div class="login-card-form">
                    ...
                    <div class="mobile-logo d-flex d-lg-none flex-column align-items-center text-center mb-4">
                        <img src="{{ asset('img/kwatogslogo.jpg') }}?v=demo" alt="{{ config('app.name') }}" style="height:120px;max-height:120px;object-fit:contain;">
